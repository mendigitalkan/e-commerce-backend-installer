            ...
            case 1:
                ...
                return [4 /*yield*/, carts_1.CartsModel.findOne({
                        where: {
                            ...
                            cartId: (_b = {}, _b[sequelize_1.Op.eq] = requestBody.cartId, _b)
                        }
                    })];
            case 2:
                result = _e.sent();
                ...
                newData = __assign(__assign(__assign({}, (requestBody.cartProductId.length > 0 && {
                ...
                return [4 /*yield*/, carts_1.CartsModel.update(newData, {
                        where: {
                            deleted: (_c = {}, _c[sequelize_1.Op.eq] = 0, _c),
                            cartId: (_d = {}, _d[sequelize_1.Op.eq] = requestBody.cartId, _d)
                        }
                    })];
            case 3:
                _e.sent();
