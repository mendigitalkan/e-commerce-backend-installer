...
var findAllCart = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_j) {
        switch (_j.label) {
            case 0:
                _j.trys.push([0, 2, , 3]);
                page = new pagination_1.Pagination((_e = parseInt(req.query.page)) !== null && _e !== void 0 ? _e : 0, (_f = parseInt(req.query.size)) !== null && _f !== void 0 ? _f : 10);
                return [4 /*yield*/, carts_1.CartsModel.findAndCountAll(__assign({ where: __assign({ deleted: (_a = {}, _a[sequelize_1.Op.eq] = 0, _a), cartUserId: (_b = {}, _b[sequelize_1.Op.eq] = (_h = (_g = req.body) === null || _g === void 0 ? void 0 : _g.user) === null || _h === void 0 ? void 0 : _h.userId, _b) }, (Boolean(req.query.search) && (_c = {},
                            _c[sequelize_1.Op.or] = [{ cartProductId: (_d = {}, _d[sequelize_1.Op.like] = "%".concat(req.query.search, "%"), _d) }],
                            _c))), include: [
                            {
...
var findDetailCart = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 1:
                _f.trys.push([1, 3, , 4]);
                return [4 /*yield*/, carts_1.CartsModel.findOne({
                        where: {
                            deleted: (_a = {}, _a[sequelize_1.Op.eq] = 0, _a),
                            cartUserId: (_b = {}, _b[sequelize_1.Op.eq] = (_e = (_d = req.body) === null || _d === void 0 ? void 0 : _d.user) === null || _e === void 0 ? void 0 : _e.userId, _b),
                            cartId: (_c = {}, _c[sequelize_1.Op.eq] = requestParams.cartId, _c)
                        },
                        include: [
                            {
                                model: products_1.ProductModel
