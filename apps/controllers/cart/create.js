...
var createCart = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var requestBody, emptyField, message, response, response, result, error_1, message, response;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                requestBody.cartUserId = (_b = (_a = req.body) === null || _a === void 0 ? void 0 : _a.user) === null || _b === void 0 ? void 0 : _b.userId;
                return [4 /*yield*/, carts_1.CartsModel.create(requestBody)];
            case 2:
                _c.sent();
