...
var updateSettings = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var requestBody, emptyField, message, response, checkRole, message, response_2, result, message, response_3, newData, response, error_1, message, response;
            ...
            case 1:
                ...
                return [4 /*yield*/, user_1.UserModel.findOne({
                        where: {
                            ...
                            userId: (_h = (_g = req.body) === null || _g === void 0 ? void 0 : _g.user) === null || _h === void 0 ? void 0 : _h.userId,
                            userRole: (_b = {}, _b[sequelize_1.Op.eq] = 'superAdmin', _b)
                        }
                    })];
            case 2:
                checkRole = _j.sent();
                ...
                return [4 /*yield*/, settings_1.SettingsModel.findOne({
                        where: {
                            deleted: (_c = {}, _c[sequelize_1.Op.eq] = 0, _c),
                            settingId: (_d = {}, _d[sequelize_1.Op.eq] = requestBody.settingId, _d)
                        }
                    })];
            case 3:
                result = _j.sent();
                if (result == null) {
                    ...
                    return [2 /*return*/, res.status(http_status_codes_1.StatusCodes.NOT_FOUND).json(response_3)];
                }
                newData = __assign(__assign({}, (requestBody.settingBanner.length > 0 && {
                ...
                return [4 /*yield*/, settings_1.SettingsModel.update(newData, {
                        where: {
                            deleted: (_e = {}, _e[sequelize_1.Op.eq] = 0, _e),
                            settingId: (_f = {}, _f[sequelize_1.Op.eq] = requestBody.settingId, _f)
                        }
                    })];
            case 4:
                _j.sent();
