...
var userLogin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var requestBody, emptyField, message, response, user, message, response_2, message, response_3, token, response, error_1, message, response;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                user = _c.sent();
                if (user == null) {
                    message = 'Akun tidak ditemukan. Silahkan lakukan pendaftaran terlebih dahulu!';
                ...
                if ((0, scure_password_1.hashPassword)(requestBody.userPassword) !== user.userPassword) {
                    ...
                    return [2 /*return*/, res.status(http_status_codes_1.StatusCodes.UNAUTHORIZED).json(response_3)];
                }
