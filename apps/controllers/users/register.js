...
var scure_password_1 = require("../../utilities/scure_password");
var uuid_1 = require("uuid");
var userRegister = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var requestBody, emptyField, message, response, user, message, response_2, response, error_1, message, response;
    var _a, _b;
            ...
            case 1:
                ...
                return [4 /*yield*/, user_1.UserModel.findOne({
                        ...
                        where: {
                            ...
                            userEmail: (_b = {}, _b[sequelize_1.Op.eq] = requestBody.userEmail, _b)
                        }
                    })];
            case 2:
                user = _c.sent();
                if (user != null) {
                    message = "Email ".concat(user.userEmail, " sudah terdaftar. Silahkan gunakan email lain.");
                    response_2 = response_1.ResponseData.error(message);
                    return [2 /*return*/, res.status(http_status_codes_1.StatusCodes.BAD_REQUEST).json(response_2)];
                }
                requestBody.userPassword = (0, scure_password_1.hashPassword)(requestBody.userPassword);
                requestBody.userId = (0, uuid_1.v4)();
                return [4 /*yield*/, user_1.UserModel.create(requestBody)];
            case 3:
                _c.sent();
                response = response_1.ResponseData.default;
                response.data = { message: 'success' };
                return [2 /*return*/, res.status(http_status_codes_1.StatusCodes.CREATED).json(response)];
            case 4:
                error_1 = _c.sent();
