...
var removeNofication = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            case 1:
                ...
                return [4 /*yield*/, notifications_1.NotificationModel.findOne({
                        where: {
                            ...
                            notificationId: (_b = {}, _b[sequelize_1.Op.eq] = requestQuery.notificationId, _b)
                        }
                    })];
            case 2:
                result = _c.sent();
