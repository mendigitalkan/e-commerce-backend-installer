            ...
            case 1:
                ...
                return [4 /*yield*/, notifications_1.NotificationModel.findOne({
                        where: {
                            ...
                            notificationId: (_b = {}, _b[sequelize_1.Op.eq] = requestBody.notificationId, _b)
                        }
                    })];
            case 2:
                result = _e.sent();
                ...
                newData = __assign(__assign({}, (requestBody.notificationName.length > 0 && {
                ...
                return [4 /*yield*/, notifications_1.NotificationModel.update(newData, {
                        where: {
                            deleted: (_c = {}, _c[sequelize_1.Op.eq] = 0, _c),
                            notificationId: (_d = {}, _d[sequelize_1.Op.eq] = requestBody.notificationId, _d)
                        }
                    })];
            case 3:
                _e.sent();
