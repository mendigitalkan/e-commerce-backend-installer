...
exports.findDetailAddress = exports.findAllAddress = void 0;
...
var findAllAddress = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                ...
                return [4 /*yield*/, address_1.AddressesModel.findAndCountAll(__assign({ where: __assign({ deleted: (_a = {}, _a[sequelize_1.Op.eq] = 0, _a) }, (Boolean(req.query.search) && (_b = {},
                            _b[sequelize_1.Op.or] = [{ addressName: (_c = {}, _c[sequelize_1.Op.like] = "%".concat(req.query.search, "%"), _c) }],
...
var findDetailAddress = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 3, , 4]);
                return [4 /*yield*/, address_1.AddressesModel.findOne({
                        where: {
                            deleted: (_a = {}, _a[sequelize_1.Op.eq] = 0, _a),
                            addressId: (_b = {}, _b[sequelize_1.Op.eq] = requestParams.addressId, _b)
                        }
                    })];
            case 2:
                result = _c.sent();
...
exports.findDetailAddress = findDetailAddress;
