            ...
            case 1:
                ...
                return [4 /*yield*/, address_1.AddressesModel.findOne({
                        where: {
                            ...
                            addressId: (_b = {}, _b[sequelize_1.Op.eq] = requestBody.addressId, _b)
                        }
                    })];
            case 2:
                result = _e.sent();
                ...
                newData = __assign({}, (requestBody.addressName.length > 0 && {
                    addressName: requestBody.addressName
                }));
                return [4 /*yield*/, address_1.AddressesModel.update(newData, {
                        where: {
                            deleted: (_c = {}, _c[sequelize_1.Op.eq] = 0, _c),
                            addressId: (_d = {}, _d[sequelize_1.Op.eq] = requestBody.addressId, _d)
                        }
                    })];
            case 3:
                _e.sent();
