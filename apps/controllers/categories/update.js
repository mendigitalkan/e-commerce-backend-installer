            ...
            case 1:
                ...
                return [4 /*yield*/, categories_1.CategoriesModel.findOne({
                        where: {
                            ...
                            categoryId: (_b = {}, _b[sequelize_1.Op.eq] = requestBody.categoryId, _b)
                        }
                    })];
            case 2:
                result = _e.sent();
                ...
                newData = __assign({}, (requestBody.categoryName.length > 0 && {
                    categoryName: requestBody.categoryName
                }));
                return [4 /*yield*/, categories_1.CategoriesModel.update(newData, {
                        where: {
                            deleted: (_c = {}, _c[sequelize_1.Op.eq] = 0, _c),
                            categoryId: (_d = {}, _d[sequelize_1.Op.eq] = requestBody.categoryId, _d)
                        }
                    })];
            case 3:
                _e.sent();
