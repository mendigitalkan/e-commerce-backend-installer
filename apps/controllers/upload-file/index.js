...
var uploadFile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var filePath, fileUrl, message, response;
    return __generator(this, function (_a) {
        try {
            filePath = req.file.path;
            fileUrl = "http://localhost:".concat(configs_1.CONFIG.port, "/").concat(filePath);
            res.json({ message: 'File uploaded successfully!', fileUrl: fileUrl });
        }
        catch (error) {
            message = "unable to process request! error ".concat(error.message);
