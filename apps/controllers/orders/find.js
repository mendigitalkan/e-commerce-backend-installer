...
var findAllOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                ...
                return [4 /*yield*/, orders_1.OrdersModel.findAndCountAll(__assign({ where: __assign({ deleted: (_a = {}, _a[sequelize_1.Op.eq] = 0, _a) }, (Boolean(req.query.search) && (_b = {},
                            _b[sequelize_1.Op.or] = [{ orderProductName: (_c = {}, _c[sequelize_1.Op.like] = "%".concat(req.query.search, "%"), _c) }],
...
var findDetailOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            case 1:
                ...
                return [4 /*yield*/, orders_1.OrdersModel.findOne({
                        where: {
                            ...
                            orderId: (_b = {}, _b[sequelize_1.Op.eq] = requestParams.orderId, _b)
                        }
                    })];
            case 2:
                result = _c.sent();
