            ...
            case 1:
                ...
                return [4 /*yield*/, transactions_1.TransactionsModel.findOne({
                        where: {
                            ...
                            transactionOrderId: (_b = {}, _b[sequelize_1.Op.eq] = requestBody.transactionOrderId, _b)
                        }
                    })];
            case 2:
                result = _e.sent();
                ...
                newData = __assign({}, (requestBody.transactionId.length > 0 && {
                    transactionId: requestBody.transactionId
                }));
                return [4 /*yield*/, transactions_1.TransactionsModel.update(newData, {
                        where: {
                            deleted: (_c = {}, _c[sequelize_1.Op.eq] = 0, _c),
                            transactionId: (_d = {}, _d[sequelize_1.Op.eq] = requestBody.transactionId, _d)
                        }
                    })];
            case 3:
                _e.sent();
