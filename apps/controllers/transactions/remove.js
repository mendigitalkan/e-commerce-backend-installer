...
var removeTransaction = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            case 1:
                ...
                return [4 /*yield*/, transactions_1.TransactionsModel.findOne({
                        where: {
                            ...
                            transactionId: (_b = {}, _b[sequelize_1.Op.eq] = requestQuery.transactionId, _b)
                        }
                    })];
            case 2:
                result = _c.sent();
