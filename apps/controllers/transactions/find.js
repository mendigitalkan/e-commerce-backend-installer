...
var findAllTransaction = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                ...
                return [4 /*yield*/, transactions_1.TransactionsModel.findAndCountAll(__assign({ where: __assign({ deleted: (_a = {}, _a[sequelize_1.Op.eq] = 0, _a) }, (Boolean(req.query.search) && (_b = {},
                            _b[sequelize_1.Op.or] = [{ transactionId: (_c = {}, _c[sequelize_1.Op.like] = "%".concat(req.query.search, "%"), _c) }],
                            _b))), include: [
                            {
...
var findDetailTransaction = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 3, , 4]);
                return [4 /*yield*/, transactions_1.TransactionsModel.findOne({
                        where: {
                            deleted: (_a = {}, _a[sequelize_1.Op.eq] = 0, _a),
                            transactionId: (_b = {}, _b[sequelize_1.Op.eq] = requestParams.transactionId, _b)
                        },
                        include: [
                            {
                                model: user_1.UserModel,
