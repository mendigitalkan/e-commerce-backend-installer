            ...
            case 1:
                ...
                return [4 /*yield*/, products_1.ProductModel.findOne({
                        where: {
                            ...
                            productId: (_b = {}, _b[sequelize_1.Op.eq] = requestBody.productId, _b)
                        }
                    })];
            case 2:
                result = _e.sent();
                ...
                newData = __assign(__assign(__assign(__assign({}, (requestBody.productName.length > 0 && {
                ...
                return [4 /*yield*/, products_1.ProductModel.update(newData, {
                        where: {
                            deleted: (_c = {}, _c[sequelize_1.Op.eq] = 0, _c),
                            productId: (_d = {}, _d[sequelize_1.Op.eq] = requestBody.productId, _d)
                        }
                    })];
            case 3:
                _e.sent();
