...
var settingRouters = function (app) {
    ...
    router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, settings_1.settingsController.findSettings(req, res)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    }); }); });
    router.patch('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, settings_1.settingsController.updateSettings(req, res)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    }); }); });
};
